...
exports.OTP_VALIDATION = exports.RESET_TOKEN_MESSAGES = exports.REFRESH_TOKEN_MESSAGES = exports.OTP_MESSAGES = exports.USER_MESSAGES = exports.OTPConstants = void 0;
class OTPConstants {
}
exports.OTPConstants = OTPConstants;
OTPConstants.MAX_ATTEMPTS = 5;
OTPConstants.RESEND_COOLDOWN = 60;
exports.USER_MESSAGES = {
    ...
    ERRORS: {
        ...
        LOGOUT_FAILED: (error) => `'Failed to logout: ' + ${error})`,
...
exports.OTP_MESSAGES = {
    ...
    ERRORS: {
        ...
        INVALID_OR_EXPIRED: (attempts) => `Invalid or expired OTP. You have ${attempts} attempts left.`,
...
exports.REFRESH_TOKEN_MESSAGES = {
    SUCCESS: {
