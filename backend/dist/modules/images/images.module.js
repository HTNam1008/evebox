...
const images_service_1 = require("./commands/images/images.service");
const images_controller_1 = require("./commands/images/images.controller");
...
exports.ImagesModule = ImagesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [images_service_1.ImagesService, images_repository_1.ImagesRepository],
