...
export class GetEventRecommendDto {
...
export class GetRecommendEventResponse{
  ...
  @ApiProperty({ type: [GetEventRecommendDto], description: 'Events data list' })
  data: GetEventRecommendDto[];
}