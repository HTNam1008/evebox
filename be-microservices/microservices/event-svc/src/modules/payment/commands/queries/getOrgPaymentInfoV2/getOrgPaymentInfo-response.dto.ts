...
export class OrgPaymentInfoDataDtoV2 {
...
export class GetOrgPaymentInfoResponseDtoV2 extends BaseResponse {
  @ApiProperty({ type: OrgPaymentInfoDataDtoV2, description: 'OrgPaymentInfo data' })
  data: OrgPaymentInfoDataDtoV2;
}