...
export default function SearchBar({ onSearch }: SearchBarProps) {
    ...
    return (
        <div className="searchbar-showing-management flex items-center border border-gray-300 rounded-md overflow-hidden w-1/3 bg-white text-sm">
            <input type="text" className="w-full px-3 py-2 outline-none"
                placeholder="Tìm kiếm theo ID hoặc tên sự kiện"
                value={searchTerm}
