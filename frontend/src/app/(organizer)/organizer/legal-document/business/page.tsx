...
export default function PdfViewerPage() {
    ...
    useEffect(() => {
        ...
        const url = "https://raw.githubusercontent.com/huethanh-2805/term-evebox/main/6.%20Evebox_Danh_muc_hang_hoa_dich_cam_kinh_doanh_va_kinh_doanh_co_dieu_kien.pdf";
