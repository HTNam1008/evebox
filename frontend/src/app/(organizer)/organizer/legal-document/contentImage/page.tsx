...
/* Package Application */
import { handleFileChange as handleFileChangeUtil } from '@/app/(dashboard)/libs/functions/handleFileChange';
...
export default function PdfViewerPage() {
    ...
    useEffect(() => {
        ...
        const url = "https://raw.githubusercontent.com/huethanh-2805/term-evebox/main/7.%20Evebox_Quy_che_kiem_dinh_noi_dung_hinh_anh.pdf";
    ...
    return isClient ? (
        <div>
            <div className="flex items-center space-x-2">
                ...
                <h1 className=" text-2xl font-bold text-[#0C4762]">Quy định kiểm duyệt nội dung & hình ảnh</h1>
            </div>
