    ...
    <div className="p-6 bg-[#E6F6F1] rounded-lg border border-[#BEE3DB] space-y-6 shadow-lg">
      ...
      <div>
        ...
        <div className="relative">
          <input
            className="w-full p-2 border rounded border-gray-300 pr-10 text-sm"
      ...
      {voucherType === "multiple" && (
        <>
          ...
          <div>
            ...
            />
            <p className="text-sm text-gray-500">Có thể tạo tối đa 5000 mã. Mỗi mã chỉ áp dụng 1 lần.</p>
          </div>
          ...
          <div>
            ...
            />
            <p className="text-sm text-gray-500">Mã sẽ tạo theo mẫu: {prefix || "HELLO"} + &lt;random&gt;</p>
          </div>
        </>
      )}
